 ...
 * @LastEditTime: 2023-05-30 11:23:41
 * @LastEditors: xcq
-->
<template>
  <div id="m-footer">
    <div class="footer-wrap">
      <p>
        本博客已运行<span>{{ runningTime }}</span><span class="time-jump">(●'◡'●)ﾉ♥</span>
      </p>
      <p>
      ...
      <p>
        本站由 @{{ blogInfo.blogName || '博客' }} 创建 - © 2020. <a href="https://beian.miit.gov.cn/" target="_blank">京ICP备2020039465号-1</a>
      </p>
    </div>
  </div>
</template>
...
export default {
  ...
  methods: {
    running() {
      let startTime = new Date('2020/09/29 00:00:00')
